# This Makefile is for the WWW::Search::Excite::News extension to perl.
#
...
#	NAME => q[WWW::Search::Excite::News]
#	PREREQ_PM => { WWW::Search=>q[2] }
#	VERSION_FROM => q[News.pm]
...
DISTNAME = WWW-Search-Excite-News
NAME_SYM = WWW_Search_Excite_News
VERSION = 2.04
VERSION_SYM = 2_04
XS_VERSION = 2.04
INST_BIN = blib/bin
...
FULLEXT = WWW/Search/Excite/News
BASEEXT = News
PARENT_NAME = WWW::Search::Excite
DLBASE = $(BASEEXT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/WWW/Search/Excite
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/WWW/Search/Excite
...
manifypods : pure_all News.pm
	@$(POD2MAN) \
	News.pm \
	$(INST_MAN3DIR)/WWW::Search::Excite::News.$(MAN3EXT)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"WWW-Search-Excite-News\" VERSION=\"2,04,0,0\">\n}. qq{\t<TITLE>WWW-Search-Excite-News</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"WWW-Search\" VERSION=\"2,0,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > WWW-Search-Excite-News.ppd
